...
loot_emp::loot_emp(class Game* game, Vector2 pos) :
	loot(game, pos)
{
	...
	class Spritecomponent_offset_position* mytext = new Spritecomponent_offset_position(this, 1, 4, -10, -16-12);
	SDL_Color col = { 0,0,0,255 };
	mytext->settextue(game->get_text_as_texture("emp", col, 12));//6.66 pixel per charecter of size 12 text
}
void loot_emp::functionality()
{
	getgame()->getship()->set_mag_type(Ship::emp);
